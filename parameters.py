...
def get_data(csv_type):
    ...
    if csv_type == "seeds":
        ...
        # PEQUEÑOS
        e_profesor_profesor = pd.read_csv('source/small/distancias_entre_profes.csv', header=None)
        j_profesor_bloque = pd.read_csv('source/small/distancias_profe_colegio.csv', header=None)
        postulaciones_profesores_ramos = pd.read_csv('source/small/ramos_postulados.csv', header=None)
        preferencias_profesores_bloques = pd.read_csv('source/small/preferencias_bloque.csv', header=None)
        puede_manejar_profesores = pd.read_csv('source/small/maneja.csv', header=None)
        q_profesor_ramo = pd.read_csv('source/small/requisitos_bloque.csv', header=None)
